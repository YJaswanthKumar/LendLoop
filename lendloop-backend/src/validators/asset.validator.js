...
const { ASSET_AVAILABILITY, CANCELLATION_POLICY } = require('../utils/constants');
...
const createAssetValidator = [
  ...
  body('cancellationPolicy').optional({ nullable: true }).isIn(Object.values(CANCELLATION_POLICY)),
